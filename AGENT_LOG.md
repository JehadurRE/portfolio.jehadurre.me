...
|---|------|------|-------|----------|-------|
| 8 | 2026-08-08 | building-bengali-pdf-harfbuzz-flutter | Deep Dive: Building bengali_pdf for HarfBuzz-Shaped Bangla Text in Flutter | Project | 982 |
...
- Projects: Work in progress aimed at generating detailed images from Bangla textual descriptions using generative models. ML models for software engineering and data analysis. bengali_pdf.
...
- 🚫 Run SQL insert script `blog-posts/drafts/building-bengali-pdf-harfbuzz-flutter.sql` in Supabase
- 🚫 Create `public/blog/building-bengali-pdf-harfbuzz-flutter-cover.jpg` (1200x630px)
...
### 2026-08-08 — Day 13 — WRITE MODE
**Branch:** blog/building-bengali-pdf-harfbuzz-flutter-2026-08-08
**PR:** blog: "Deep Dive: Building bengali_pdf for HarfBuzz-Shaped Bangla Text in Flutter" — Project
**Mode:** WRITE
**Files changed:**
- `content/blog/building-bengali-pdf-harfbuzz-flutter.md`: Created new project breakdown blog post.
- `blog-posts/drafts/building-bengali-pdf-harfbuzz-flutter.sql`: Created SQL draft.

**If WRITE:**
- Post title: Deep Dive: Building bengali_pdf for HarfBuzz-Shaped Bangla Text in Flutter
- Slug: /blog/building-bengali-pdf-harfbuzz-flutter
- Category: Project
- Word count: 982
- Primary keyword: bengali_pdf flutter harfbuzz
- File: content/blog/building-bengali-pdf-harfbuzz-flutter.md

**Build:** pnpm lint ✅ | pnpm build ✅
**Notes:** Wrote a deep dive on building the bengali_pdf project for Flutter, detailing HarfBuzz integration for complex text shaping.
