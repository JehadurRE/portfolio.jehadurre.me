                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full mt-4 py-2 px-4 bg-green-600 hover:bg-green-700 text-white rounded transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-400"
                    >
                      {isSubmitting ? (
                        <span aria-live="polite" className="flex items-center space-x-2">
