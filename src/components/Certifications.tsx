...
const Certifications: React.FC = () => {
  ...
  // Use `reduce` to calculate counts in a single O(N) pass for certifications and achievements.
  // Expected impact: Prevents unnecessary heavy multiple iterations, improving UI responsiveness.
