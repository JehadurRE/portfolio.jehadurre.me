INSERT INTO public.blog_posts (
  ...
  'building-bengali-pdf-harfbuzz-flutter',
  'Learn how I built bengali_pdf to render complex HarfBuzz-shaped, searchable Bangla text in Flutter applications.',
  '# Deep Dive: Building bengali_pdf for HarfBuzz-Shaped Bangla Text in Flutter
...
*Did this help? Share it on [Twitter/X](https://twitter.com/intent/tweet?text=Deep%20Dive%3A%20Building%20bengali_pdf%20for%20HarfBuzz-Shaped%20Bangla%20Text%20in%20Flutter&url=https://jehadurre.me/blog/building-bengali-pdf-harfbuzz-flutter) or [connect with Jehad on LinkedIn](https://linkedin.com/in/jehadurre).*',
  'Project',
  '{"flutter", "dart", "harfbuzz", "typography", "pdf"}',
  '/blog/building-bengali-pdf-harfbuzz-flutter-cover.jpg',
  '2026-08-08T00:00:00.000Z',
  4,
  'Building bengali_pdf for HarfBuzz-Shaped Bangla Text in Flutter',
  'A comprehensive guide on building bengali_pdf, a Flutter package that integrates HarfBuzz to correctly shape and render complex Bangla text in PDFs.',
  true,
  0,
  NOW(),
  NOW()
