INSERT INTO blog_posts (slug, title, excerpt, content, cover_image, tags, category, reading_time, published_at, updated_at, is_published, seo_title, seo_description)
VALUES (
  'project-breakdown-bengali-pdf-flutter',
  'Project Breakdown: Searchable Bengali PDFs in Flutter Native Platforms',
  'A deep dive into how I built bengali_pdf to render HarfBuzz-shaped, fully searchable Bengali text in Flutter apps natively without losing accessibility or search capabilities.',
  '# Project Breakdown: Searchable Bengali PDFs in Flutter Native Platforms
...
*Did this help? Share it on [Twitter/X](https://twitter.com/intent/tweet?text=Project%20Breakdown%3A%20Searchable%20Bengali%20PDFs%20in%20Flutter&url=https://jehadurre.me/blog/project-breakdown-bengali-pdf-flutter) or [connect with Jehad on LinkedIn](https://linkedin.com/in/jehadurre).*',
  '/blog/project-breakdown-bengali-pdf-flutter-cover.jpg',
  ARRAY['flutter', 'dart', 'pdf', 'harfbuzz', 'bengali'],
  'Project',
  5,
  '2026-08-05',
  '2026-08-05',
  true,
  'Project Breakdown: Searchable Bengali PDFs in Flutter',
  'A deep dive into how I built bengali_pdf to render HarfBuzz-shaped, fully searchable Bengali text in Flutter apps natively.'
);