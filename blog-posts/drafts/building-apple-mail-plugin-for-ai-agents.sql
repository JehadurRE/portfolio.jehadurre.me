INSERT INTO blog_posts (
  title, slug, excerpt, content, cover_image, category, tags, published_at, reading_time, updated_at, is_published, seo_title, seo_description
) VALUES (
  'Building an Apple Mail Plugin for AI Agents with TypeScript and AppleScript',
  'building-apple-mail-plugin-for-ai-agents',
  'Discover how to build a robust Apple Mail channel plugin for OpenClaw and Hermes, enabling AI agents to read and respond to emails with per-thread session isolation.',
  '# Building an Apple Mail Plugin for AI Agents with TypeScript and AppleScript
...
*Did this deep dive help you? Share it on [Twitter/X](https://twitter.com/intent/tweet?text=Building%20an%20Apple%20Mail%20Plugin%20for%20AI%20Agents%20with%20TypeScript&url=https://jehadurre.me/blog/building-apple-mail-plugin-for-ai-agents) or [connect with Jehad on LinkedIn](https://linkedin.com/in/jehadurre).*',
  '/blog/building-apple-mail-plugin-for-ai-agents-cover.jpg',
  'Project',
  ARRAY['TypeScript', 'AppleScript', 'AI', 'Automation', 'macOS'],
  '2026-08-06',
  5,
  '2026-08-06',
  true,
  'Building an Apple Mail Plugin for AI Agents with TypeScript',
  'Discover how to build a robust Apple Mail channel plugin for OpenClaw and Hermes, enabling AI agents to read and respond to emails with per-thread session isolation.'
);
